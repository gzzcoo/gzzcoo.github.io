...
> **Note:** Active Directory often prevents direct conversion from Domain Local to Global. You must first convert it to a Security Universal Group (`-2147483640`), and then to a Security Global Group (`-2147483644`).
...
Change to Security Global Group (`-2147483644`):
```sh
